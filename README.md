...
Для их загрузки нужно либо копировать репозиторий вместе с ними (git clone --recurse-submodules <url>), или инициализировать их после стандартного git clone: git submodule update --init --recursive.
